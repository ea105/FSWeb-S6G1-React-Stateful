...
ADIM 1:
  State hookunu kullanara, bir 'dondurucuAcik', 'setDondurucuAcik' çifti oluşturun.
  'dondurucuAcik' true olarak yüklendiğinde döndürücü görünür olacak.
...
ADIM 3:
  'dondurucuAcik' değerine bağlı olarak "Gizle" veya "Göster" metni oluşturmak için button içinde bir ifade kullanın.
...
export default function Dondurucu() {
  /* ADIM 1 */
  const [dondurucuAcik, setDondurucuAcik] = useState(true); /* ADIM 1 */

  const toggleDondurucu = () => {
    /* ADIM 4 */
    // setDondurucuAcik(dondurucuAcik ? false : true);
